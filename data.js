...
function seedState(){
  return {
    ...
    notifications:[
      {id:'n1', friendId:'f1', type:'upcoming', text:'Через 2 дня день рождения у <b>Никиты Орлова</b>', receivedAt:'2026-07-03T09:15:00'},
      {id:'n2', friendId:'f2', type:'upcoming', text:'Через 7 дней день рождения у <b>Ивана Петрова</b>', receivedAt:'2026-07-03T09:15:00'},
      {id:'n3', friendId:'f4', type:'past', text:'День рождения <b>Дмитрия Волкова</b> прошёл 15 января', receivedAt:'2026-01-15T09:00:00'}
    ]
  };
}
